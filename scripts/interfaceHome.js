    ...
    if (enteredCodeCode.length === 4) {
        if (enteredCodeCode === "3561") {            
            ...
            showCustomPopupInfo("Félicitations, détectives !", "Vous avez trouvé le coupable et l’avez mis derrière les barreaux. Grâce à vous, l’écosystème est sauvé et Romain peut retrouver son arbre en paix.");
        } else {
